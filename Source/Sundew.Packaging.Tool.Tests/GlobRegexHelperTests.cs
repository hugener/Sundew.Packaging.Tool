// --------------------------------------------------------------------------------------------------------------------
// <copyright file="GlobRegexHelperTests.cs" company="Hukano">
...
namespace Sundew.Packaging.Tool.Tests
{
    ...
    [TestFixture]
    public class GlobRegexHelperTests
    {
        ...
        {
            var regex = GlobRegexHelper.CreateRegex(@"c:\a\**\d\file.txt");
        ...
        public void IsMatch_When_MatchingWithDoubleAndSingleStar_Then_ResultShouldBeAsExpected(string input, bool expectedResult)
        {
            var regex = GlobRegexHelper.CreateRegex(@"c:\a\**\*.txt");
        ...
        {
            var regex = GlobRegexHelper.CreateRegex(@"c:\a\file.txt");
