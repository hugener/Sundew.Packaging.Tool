...
namespace Sundew.Build.Update.Tests
{
    ...
    public static class TestData
    {
        ...
        public static readonly ProjectTestData SundewBuildPublishProject = new(SundewBuildPublishData.Name, SundewBuildPublishData.Source, SundewBuildPublishData.NonPrereleaseUpdatedSource, SundewBuildPublishData.PrereleaseUpdatedSource);
        ...
        public static readonly PackageTestData SundewBuildPublishPackage = new(SundewBuildPublishData.Name, SundewBuildPublishData.PackageVersions);
        ...
        public static readonly PackageUpdate SundewBuildPublishPackageUpdateForSundewCommandLine = new(SundewBuildPublishData.Name, NuGetVersion.Parse("0.0.1"), NuGetVersion.Parse("2.2.8"));
        ...
        public static class SundewBuildPublishData
        {
            public const string Name = "Sundew.Build.Publish";
  ...
  <PropertyGroup>
    ...
    <NuspecFile>Sundew.Build.Publish.nuspec</NuspecFile>
    ...
    <RepositoryUrl>https://github.com/hugener/Sundew.Build.Publish</RepositoryUrl>
    <PackageReleaseNotes>
    ...
    <PackageProjectUrl>https://github.com/hugener/Sundew.Build.Publish</PackageProjectUrl>
  </PropertyGroup>
  ...
  <Target Name=""_CopyPackageFiles"" AfterTargets=""PostBuildEvent"">
    <ItemGroup>
      ...
      <TargetsFiles Include=""build\Sundew.Build.Publish.targets"" />
    </ItemGroup>
  ...
  <Import Project=""$(MSBuildProjectDirectory)\build\Sundew.Build.Publish.targets"" />
</Project>";
...
3.0 - Improved nesting support</PackageReleaseNotes>
  ...
  <ItemGroup>
    ...
    <PackageReference Include= ""Sundew.Build.Publish"" Version=""0.0.1"" >
      <PrivateAssets>all</PrivateAssets>
      <IncludeAssets>runtime; build; native; contentfiles; analyzers; buildtransitive</IncludeAssets>
    </PackageReference>
...
fileSystem.Setup(x =&gt; x.Exists(It.IsAny&lt;string&gt;())).Returns(true);</Description>
  ...
  <ItemGroup>
    ...
    <PackageReference Include=""Sundew.Build.Publish"" Version=""2.2.7"">
      <PrivateAssets>all</PrivateAssets>
      <IncludeAssets>runtime; build; native; contentfiles; analyzers; buildtransitive</IncludeAssets>
    </PackageReference>
  </ItemGroup>
